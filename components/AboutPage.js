		...
		return (
			<Layout>
				<Card>
					<h3>Who We Are?</h3>
					<p>
						SERVO was incorporated as an indigenous Facilities Management Company App under SOSTEIN. 
						Our primary focus is to provide facilities management, project management
